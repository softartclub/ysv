...
class News extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('isShow,  onMainList, isTopOnSections, isTopOnMain', 'length', 'max' => 1),
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'onMainList' => Yii::t('form', 'On Main News List'),
            'isTopOnMain' => Yii::t('form', 'Is Top News On Main'),
            'isTopOnSections' => Yii::t('form', 'Is Top News On Sections'),
        );
    }
