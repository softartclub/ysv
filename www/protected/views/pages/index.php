        ...
        <div class="col-1 main">
            <div class="box1">
                <?php if (is_file(Yii::app()->params['webroot'] . '/img/pages/small/' . $pages->pic)): ?>
                    <a href="/pages/<?php echo $pages->url; ?>" title="<?php echo $pages->header; ?>" title="<?php echo $pages->header; ?>">
                        <img src="<?php echo '/img/pages/small/' . $pages->pic; ?>" alt="<?php echo $pages->header; ?>" class="img" align="left"/>
                    </a>
                <?php endif; ?>
                <h4> <a href="/pages/<?php echo $pages->url; ?>" title="<?php echo $pages->header; ?>" title="<?php echo $pages->header; ?>"><?php echo $pages->header; ?></a></h4>
